...
tracking_parameters = HEBee_Eramp_parameters(op_mode='W', dec_mode = True)
ring_HEB = generate_HEB_ring(op_mode='W', particle=particle_type, Nturns=Nturns, momentum=energy_ramp)
...
gif_paths = [
    '/Users/lvalle/PycharmProjects/BLonD/Simulations_ramps/W_mode/gif_path/animated_ramp_jitter_W_mode_new_size.gif',
]
...
if tracking:
    ...
    axes.set_title('Acceleration simulation W mode')
    bl=[]
    eml=[]
    beam.statistics()
