...
class TestGettingStarted(BLonDTestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_executable_numba64(self):
        ...
        from blond.examples.notebooks import getting_started  # NOQA

        importlib.reload(getting_started)  # make sure the script is executed
