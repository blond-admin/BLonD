...
class TestPIFullTrackingMultiSectionFastRamp(unittest.TestCase):
    ...
    PIN_V_MIN = np.array(
        [
            [29587394.54086674, 29543721.861713972],
            [29455181.00392498, 29333791.416778304],
            [29203750.793566313, 29095127.05454143],
            [29028607.22219229, 29013023.86706398],
            [29048391.8537483, 29131058.54136009],
            [29248533.214682274, 29377488.797826525],
        ]
    )
    PIN_I_MAX_DEV = np.array(
        [
            [56.68218992946742, 56.75910216193461],
            [56.84716252098755, 56.86440886962128],
            [56.77991005142666, 56.61066085021321],
            [56.403147658311894, 56.21431211935741],
            [56.08799857126701, 56.062013252631075],
            [56.136687340993205, 56.26389353130394],
        ]
    )
