...
class TestEX_10_MultiRFManipulation_TripleSplitting(unittest.TestCase):
    @pytest.mark.backend_mutation
    def test_executable_numba32(self):
        backend.change_backend(Numpy32Bit)
        backend.set_specials("numba")
        from blond.examples.scripts import (
            EX_10_MultiRFManipulation_TripleSplitting,
        )

        # full script. just checking if it crashes
        EX_10_MultiRFManipulation_TripleSplitting.main(
            run_n_turns=10,
