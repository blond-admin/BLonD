...
class TestSingleBunchAcceleration(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        ipynb_to_py(
            os.path.join(
                NOTEBOOK_DIR,
                "single_bunch_acceleration.ipynb",
            ),
            os.path.join(
                NOTEBOOK_DIR,
                "single_bunch_acceleration.py",
            ),
        )
    ...
    def test_executable_numba32(self):
        ...
        from blond.examples.notebooks import single_bunch_acceleration  # NOQA

        importlib.reload(
            single_bunch_acceleration
