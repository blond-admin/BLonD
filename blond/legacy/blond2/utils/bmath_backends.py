...
class MasterBackend:
    ...
    def __init__(self):
        from blond.legacy.blond2.utils.butils_wrap_cpp import precision
    ...
    def use_fftw(self):
        ...
        from blond.legacy.blond2.utils import butils_wrap_cpp as _cpp
...
class CppBackend(__NumpyBackend):
    def __init__(self):
        ...
        from blond.legacy.blond2.utils import butils_wrap_cpp as _cpp
        from blond.legacy.blond2.utils import butils_wrap_python as _py
...
class NumbaBackend(__NumpyBackend):
    def __init__(self):
        ...
        from blond.legacy.blond2.utils import butils_wrap_numba as _nu
