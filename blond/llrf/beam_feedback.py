...
class BeamFeedback:
    ...
    def __init__(
        ...
        ##  SPS Beam feedback for proton beams (excluded fix target). It includes phase loop, syncrho loop and frequency loop
            ...
            self.delay_turns = self.config.get('delay_turns', 2) ### Delay in turns for the correction.
    ...
    def SPS_PL_SL_FL(self):
        ...
        self.domega_rf_corr= [self.domega_dphi + self.domega_sync + self.domega_freq] +  self.domega_rf_corr[:-1]
