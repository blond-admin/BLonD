...
void rf_noise_wrapper(const double *fHigh, size_t fHighSize, const double *fLow,
                      size_t fLowSize, const double *xs, size_t xsSize,
                      const double *ys, size_t ysSize, double *result,
                      size_t resultSize, const int nSource, const int nPntMin,
                      const int rSeed, const double samplingRate,
                      const double rms) {
