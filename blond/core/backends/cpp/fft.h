...
void rfft(real_t *in, const int inSize, complex_t *out, int fftSize = 0,
          const int threads = 1);
...
void fft(complex_t *in, const int inSize, complex_t *out, int fftSize = 0,
         const int threads = 1);
...
void ifft(complex_t *in, const int inSize, complex_t *out, int fftSize = 0,
          const int threads = 1);
...
void irfft(complex_t *in, const int inSize, real_t *out, int fftSize = 0,
           const int threads = 1);

void irfft_packed(complex_t *in, const int n0, const int howmany, real_t *out,
                  int fftSize = 0, const int threads = 1);
...
void fft_convolution(real_t *signal, const int signalLen, real_t *kernel,
                     const int kernelLen, real_t *res, const int threads = 1);
}
