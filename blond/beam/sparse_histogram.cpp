...
extern "C" void sparse_histogram(const real_t * __restrict__ input,
    ...
    histo[0] = (real_t *) malloc (omp_get_max_threads() * n_filled_buckets * n_slices_bucket * sizeof(real_t));
    ...
    #pragma omp parallel
    {
        ...
        memset(histo[id], 0., n_filled_buckets * n_slices_bucket * sizeof(real_t));
