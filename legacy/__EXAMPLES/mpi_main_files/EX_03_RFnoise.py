...
from blond.legacy.blond2.llrf.rf_noise import FlatSpectrum
...
RFnoise = FlatSpectrum(
    ...
    folder_plots=this_directory + "../mpi_output_files/EX_03_fig",
)
RFnoise.generate()
...
if WORKER.is_master:
    ...
    bunchmonitor = BunchMonitor(
        ...
        rf_params,
        beam,
        this_directory + "../mpi_output_files/EX_03_output_data",
        profile=slice_beam,
    )
    ...
    format_options = {
        "dirname": this_directory + "../mpi_output_files/EX_03_fig",
        "linestyle": ".",
    }
    plots = Plot(
        general_params,
        ...
        profile=slice_beam,
        h5file=this_directory + "../mpi_output_files/EX_03_output_data",
...
with open(
    this_directory + "../mpi_output_files/EX_03_test_data.txt", "w"
) as f:
    f.write(test_string)
