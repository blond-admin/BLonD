...
from blond.legacy.blond2.beam.beam import Beam, Particle
...
if WORKER.is_master:
    ...
    format_options = {
        "dirname": this_directory + "../mpi_output_files/EX_07_fig"
    }
    plots = Plot(
        general_params,
        rf_params,
...
with open(
    this_directory + "../mpi_output_files/EX_07_test_data.txt", "w"
) as f:
    f.write(test_string)
