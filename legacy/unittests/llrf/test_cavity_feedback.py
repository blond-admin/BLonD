...
class TestSPSTransmitterGain(unittest.TestCase):
    ...
    def test_preLS24sec(self):
        OTFB, V, I = self.init_otfb(
            self.rf, self.profile, self.commissioning, 4, 2, 4 / 9,1.04978045,  # old: 1.03573985
        )
    ...
    def test_preLS25sec(self):
        OTFB, V, I = self.init_otfb(
            self.rf, self.profile, self.commissioning, 5, 2, 5 / 9,1.0279351,  # old: 1.01547845
        )
    ...
    def test_postLS23sec(self):
        OTFB, V, I = self.init_otfb(
            self.rf, self.profile, self.commissioning, 3, 4, 6 / 10,1.01294445,  # old: 1.01724955
        )
    ...
    def test_postLS24sec(self):
        OTFB, V, I = self.init_otfb(
            self.rf, self.profile, self.commissioning, 4, 2, 4 / 10,1.04978045,  # old: 1.03573985
        )
...
class TestLHCCavityLoop(unittest.TestCase):
    ...
    def test_half_detuning(self):
        ...
        self.lhc_cavity_loop.half_detuning(
            imag_peak_beam_current=None,
            R_over_Q=None,
            rf_frequency=None,
            voltage=None,
        )
    ...
    def test_half_detuning_power(self):
        ...
        self.lhc_cavity_loop.half_detuning_power(
            peak_beam_current=None, voltage=None
        )
    ...
    def test_optimum_Q_L_beam(self):
        ...
        self.lhc_cavity_loop.optimum_Q_L_beam(
            R_over_Q=None, real_peak_beam_current=None, voltage=None
        )
    ...
    def test_update_set_point_excitation(self):
        ...
        self.lhc_cavity_loop.update_set_point_excitation(
            excitation=None, turn=None
        )
...
class TestLHCCavityLoopCommissioning(unittest.TestCase):
    ...
    def setUp(self):
        # TODO: implement test for `__init__`
        self.lhc_cavity_loop_commissioning = LHCCavityLoopCommissioning(
            alpha=None,
            d_phi_ad=None,
            G_a=None,
            G_d=None,
            ...
            clamping=None,
            excitation=None,
            excitation_otfb_1=None,
            excitation_otfb_2=None,
            seed1=None,
            seed2=None,
        )
