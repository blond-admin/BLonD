...
from blond.legacy.blond2.utils.butils_wrap_numba import (
...
class Test:
    ...
    def test_resonator_induced_voltage_1_turn(self):
        folder = (
            ...
            + "/_kwargs_resonator_induced_voltage_1_turn/"
        )
        examples = {}
        ...
        induced_voltage_numba, deltaT_numba = (
            resonator_induced_voltage_1_turn_numba(**kwargs_numba)
        )
