...
CL = LHCCavityLoop(rf, profile, f_c=rf.omega_rf[0, 0] / (2 * np.pi), G_gen=1,
                   I_gen_offset=0, n_cavities=8, n_pretrack=100, Q_L=35000,
                   R_over_Q=R_over_Q, tau_loop=650e-9,
                   RFFB=LHCCavityLoopCommissioning(open_loop=False, open_otfb=True,
                                                   G_a=6.8e-6, G_d=10,
                                                   excitation=False))
if PLOT_NO_BEAM:
...
CL = LHCCavityLoop(rf, profile, f_c=rf.omega_rf[0, 0]/(2 * np.pi) + d_f, G_gen=1,
                   I_gen_offset=0, n_cavities=8, n_pretrack=100, Q_L=Q_L,
                   R_over_Q=R_over_Q, tau_loop=650e-9,
                   RFFB=LHCCavityLoopCommissioning(open_loop=False, open_otfb=True,
