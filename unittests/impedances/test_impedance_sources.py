...
class TestCoherentSynchrotronRadiation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.coherent_synchrotron_radiation = CoherentSynchrotronRadiation(
            r_bend=None, gamma=None, chamber_height=None
        )
    ...
    def test__fs_spectrum(self):
        ...
        self.coherent_synchrotron_radiation._fs_spectrum(
            frequency_array=None,
            epsilon=None,
            low_frequency_transition=None,
            high_frequency_transition=None,
        )

    @unittest.skip
    def test__pp_low_frequency(self):
        # TODO: implement test for `_pp_low_frequency`
        self.coherent_synchrotron_radiation._pp_low_frequency(
            frequency_array=None, u_max=None, high_frequency_transition=None
        )

    @unittest.skip
    def test__pp_spectrum(self):
        # TODO: implement test for `_pp_spectrum`
        self.coherent_synchrotron_radiation._pp_spectrum(
            frequency_array=None, zeta_max=None
        )
...
class TestInputTable(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.resonators = Resonators(
            R_S=None, frequency_R=None, Q=None, method=None
        )
...
class TestTravelingWaveCavity(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.traveling_wave_cavity = TravelingWaveCavity(
            R_S=None, frequency_R=None, a_factor=None
        )
