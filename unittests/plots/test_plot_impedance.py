...
class TestFunctions(unittest.TestCase):
    ...
    def test_plot_impedance_vs_frequency(self):
        ...
        plot_impedance_vs_frequency(
            induced_voltage_freq=None,
            figure_index=None,
            plot_total_impedance=None,
            plot_spectrum=None,
            plot_interpolated_impedances=None,
            style=None,
            cut_left_right=None,
            cut_up_down=None,
            dirname=None,
    ...
    def test_plot_wake_vs_time(self):
        ...
        plot_wake_vs_time(
            induced_voltage_time=None,
            figure_index=None,
            plot_total_wake=None,
            plot_interpolated_wake=None,
            style=None,
            cut_left_right=None,
            cut_up_down=None,
            dirname=None,
