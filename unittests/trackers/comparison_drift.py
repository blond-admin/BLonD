...
if __name__ == "__main__":
    ...
    (
        tracked_distrib_linear,
        expected_distrib_linear,
        original_distribution_dE,
    ) = CompareDrift().run_simple()
    ...
    (
        tracked_distrib_legacy,
        expected_distrib_legacy,
        original_distribution_dE,
    ) = CompareDrift().run_legacy_order1and2()
    ...
    # Exact drift example
    (
        tracked_distrib_exact,
        expected_distrib_exact,
        original_distribution_dE,
    ) = CompareDrift().run_exact_order1and2()
    ...
    (expected_distrib, original_distribution_dE) = (
        CompareDrift().run_expected_drift()
    )

    plt.figure("Comparison between methods and expectation")
    plt.clf()
    plt.plot(tracked_distrib_linear, original_distribution_dE, label="Linear")
    plt.plot(tracked_distrib_legacy, original_distribution_dE, label="Legacy")
    plt.plot(tracked_distrib_exact, original_distribution_dE, label="Exact")
    plt.plot(
        expected_distrib,
        original_distribution_dE,
        "k--",
