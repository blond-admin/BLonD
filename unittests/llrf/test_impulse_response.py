...
class TestTravellingWaveCavity(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.travelling_wave_cavity = TravellingWaveCavity(
            l_cell=None,
            N_cells=None,
            rho=None,
            v_g=None,
    ...
    def test_impulse_response_beam(self):
        ...
        self.travelling_wave_cavity.impulse_response_beam(
            omega_c=None, time_fine=None, time_coarse=None
        )

    @unittest.skip
    def test_impulse_response_gen(self):
        # TODO: implement test for `impulse_response_gen`
        self.travelling_wave_cavity.impulse_response_gen(
            omega_c=None, time_coarse=None
        )
