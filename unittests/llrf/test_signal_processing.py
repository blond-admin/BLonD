...
#        # From real signal to IQ
#        signal_IQ = real_to_cartesian(signal)
#        
#        signal = np.around(signal, 12)
#        signal_I = np.around(signal_IQ.real, 12)
#        
#        self.assertSequenceEqual(signal.tolist(), signal_I.tolist(),
#            msg="In TestIQ test_5, real part is not correct")
...
class TestRFCurrent(unittest.TestCase):
    ...
    def test_1(self):
        ...
        rf_current = rf_beam_current(self.profile, omega, self.t_rev, lpf=False)
