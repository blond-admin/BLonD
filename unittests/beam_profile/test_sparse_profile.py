...
class testProfileClass(unittest.TestCase):
    ...
    def test_WrongTrackingFunction(self):
        sparse_profile = SparseProfileBaseClass(
            rf_station=self.rf_station,
            beam=self.beam,
            number_of_slices_per_profile=self.n_slices_rf,
            _filling_pattern=self.filling_pattern,
            _profile_length_in_buckets=int(self.profile_length_in_buckets),
    ...
    def test_onebyone(self):
        ...
        nonuniform_profile = SparseProfileBaseClass(
            self.rf_station,
            self.beam,
            self.n_slices_rf,
            self.filling_pattern,
    ...
    def test_tracker_consistency(self):
        ...
        nonuniform_profile_python = SparseProfileBaseClass(
            self.rf_station,
            self.beam,
            self.n_slices_rf,
            self.filling_pattern,
        ...
        nonuniform_profile_cpp = SparseProfileBaseClass(
            self.rf_station,
            self.beam,
            self.n_slices_rf,
            self.filling_pattern,
    ...
    def test_set_additional_cuts(self):
        ...
        sparse_profile_temoin = SparseProfileBaseClass(
            self.rf_station,
            self.beam,
            self.n_slices_rf,
