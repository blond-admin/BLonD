...
class TestSynchtrotronRadiation(unittest.TestCase):
    ...
    def test_input(self):
        ...
        self.assertTrue(ring_srflag._use_synchrotron_radiation)
        harmonic_number = 184
        voltage = 800e3  # eV
        phi_offsets = 0
        rfcav_1 = RFStation(
        ...
        ## Ring object does not include synchrotron radiation
        ring = Ring(
            90,
            1e-6,
            20e9,
