...
def run(N_b = 1e9, N_p = 50000, tau_0 = 0.4e-9,
            p_i=450e9, p_f = 460.005e9, h = 35640, V = 6e6,
            show_separatrix = True, fit = "gaussian"):
    ...
    plots = Plot(ring, rf, beam, dt_plt, N_t, 0, 0.0001763*h,
                 -400e6, 400e6, xunit='rad', separatrix_plot=show_separatrix,
