...
os.makedirs(this_directory + '../output_files/EX_18_fig/', exist_ok=True)
...
plt.savefig(this_directory + '../output_files/EX_18_fig/bunch_length_multi_formalism_nsection_1.png')
plt.close()
