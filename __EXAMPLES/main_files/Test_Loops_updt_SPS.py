...
from blond.llrf.beam_feedback_update_subclasses import BeamFeedback_SPS
...
# Phase & Radial loop
phase_loop = BeamFeedback_SPS(general_params, rf_params, slices_ring,
                              PL_gain=0.01, RL_gain=0.01)
