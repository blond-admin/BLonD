...
os.makedirs(this_directory + '../gpu_output_files/EX_09_fig', exist_ok=True)
...
# Phase loop
phase_loop = BeamFeedbackPSB(general_params, rf_params, slices_ring, PL_gain=0, gain_radial_loop=[1.e7, 1.e11], dt=10.e-6)
...
bunch_monitor = BunchMonitor(general_params, rf_params, my_beam,
                             this_directory + '../gpu_output_files/EX_09_output_data',
...
plots = Plot(general_params, rf_params, my_beam, 100, n_turns, 0.0, 2.0 * 0.9e-6,
             ...
             h5file=this_directory + '../gpu_output_files/EX_09_output_data', phase_loop=phase_loop)
...
test_string += '{:+10.10e}\t{:+10.10e}\t{:+10.10e}\t{:+10.10e}\n'.format(
    my_beam.dE.mean(), my_beam.dE.std(), my_beam.dt.mean(), my_beam.dt.std())
with open(this_directory + '../gpu_output_files/EX_09_test_data.txt', 'w') as f:
    f.write(test_string)
