...
format_options = {
    "dirname": this_directory + "../gpu_output_files/EX_02_fig",
    "linestyle": ".",
}
plots = Plot(
    ring,
    ...
    profile=slice_beam,
    h5file=this_directory + "../gpu_output_files/EX_02_output_data",
...
map_ = (
    [total_induced_voltage] + [ring_RF_section] + [slice_beam]
)  # + [bunchmonitor] + [plots]
...
with open(
    this_directory + "../gpu_output_files/EX_02_test_data.txt", "w"
) as f:
    f.write(test_string)
