...
if WORKER.is_master:
    ...
    # Plots
    format_options = {
        "dirname": this_directory + "../mpi_output_files/EX_10_fig"
    }
    plots = Plot(
        general_params,
        rf_params,
        ...
        h5file=this_directory + "../mpi_output_files/EX_10_output_data",
        phase_loop=phase_loop,
    )
...
with open(
    this_directory + "../mpi_output_files/EX_10_test_data.txt", "w"
) as f:
    f.write(test_string)
