...
class SparseSlices(object):
    ...
    *This class instantiates a Slice object for each filled bucket according
    ...
    def __init__(self, RFSectionParameters, Beam, n_slices, filling_pattern,
        ...
        #: *Filling pattern as a boolean array where True (1) means filled bucket.*
        self.filling_pattern = filling_pattern
        
        # Buunch index for each filled bucket (-1 if empty). Only for C++ track.
    ...
    def _histrogram_one_by_one(self):
        '''
        *Histrogram generated by calling the tack() method of each slices object*
        '''
