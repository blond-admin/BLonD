...
subprocess.run(f"monkeytype run runtest.py") # should generate monkeytype.sqlite3 database with potential type hits
subprocess.run(f"monkeytype list-modules.py") # lists all available modules that might be type hinted
