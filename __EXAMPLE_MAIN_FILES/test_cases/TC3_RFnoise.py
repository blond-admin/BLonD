...
slice_beam = Slices(beam, 100, slicing_coord = 'tau', fit_option = 'gaussian')
slice_beam.track(beam)

# Define what to save in file
bunchmonitor = BunchMonitor('../output_files/TC3_output_data', N_t+1, slice_beam)
...
plot_long_phase_space(beam, general_params, rf_params, 0, 0.0001763, -450, 450, separatrix_plot = True, dirname = '../output_files/TC3_fig')
plot_beam_profile(0, general_params, slice_beam, dirname = '../output_files/TC3_fig', style = '.')
plot_bunch_length_evol('../output_files/TC3_output_data', general_params, 0, unit='ns', dirname = '../output_files/TC3_fig')
plot_bunch_length_evol_gaussian('../output_files/TC3_output_data', general_params, slice_beam, 0, unit='ns', dirname = '../output_files/TC3_fig')
...
for i in range(1,N_t+1):
    ...
    if (i % dt_plt) == 0:
        plot_long_phase_space(beam, general_params, rf_params, 0, 0.0001763, -450, 450, separatrix_plot = True, dirname = '../output_files/TC3_fig')
        plot_beam_profile(i, general_params, slice_beam, dirname = '../output_files/TC3_fig', style = '.')
        plot_bunch_length_evol('../output_files/TC3_output_data', general_params, i, unit='ns', dirname = '../output_files/TC3_fig')
        plot_bunch_length_evol_gaussian('../output_files/TC3_output_data', general_params, slice_beam, i, unit='ns', dirname = '../output_files/TC3_fig')
