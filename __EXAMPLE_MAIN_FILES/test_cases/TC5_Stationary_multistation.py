...
for i in range(N_t):
    ...
    if (i % dt_plt) == 0:
        plot_bunch_length_evol('../output_files/TC5_output_data', general_params, i, unit='ns', dirname = '../output_files/TC5_fig')
        plot_bunch_length_evol_gaussian('../output_files/TC5_output_data', general_params, slice_beam, i, unit='ns', dirname = '../output_files/TC5_fig')
