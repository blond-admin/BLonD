...
configuration = {'machine': 'PSB', 'PL_gain': 0.*np.ones(n_turns), 'RL_gain': [1.e7,1.e11], 'PL_period': 10.e-6, 'RL_period': 7}
...
plots = Plot(general_params, rf_params, my_beam, 100, n_turns, -0.9e-6, 0.9e-6, -1.e6, 1.e6, 
