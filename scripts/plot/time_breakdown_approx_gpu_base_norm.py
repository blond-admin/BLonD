...
if __name__ == '__main__':
    ...
    for col, case in enumerate(args.cases):
        ...
        for key in final_dir.keys():
            if ('approx0' in key) and ('precdouble' in key):
                y_ref = get_values(final_dir[key]['total'], header, gconfig['y_name'])
                break
