...
gconfig = {
    ...
    'colors': {
        ...
        'CuBLonD-1': 'tab:orange',
        'CuBLonD-1-F32-SRP': 'tab:blue',
        'CuBLonD-1-F32-RDS': 'tab:green',

        'CuBLonD-2': 'tab:orange',
        'CuBLonD-2-F32-SRP': 'tab:blue',
        'CuBLonD-2-F32-RDS': 'tab:green',
...
if __name__ == '__main__':
    ...
    for col, case in enumerate(args.cases):
        ...
        plots_dir = {}
        for row, indir, platform in zip([1, 2], [args.inputgpu, args.inputgpu2],
                                        ['gpu', 'gpu2']):
            if not indir:
                continue
            plots_dir[platform] = {}
        ...
        for row, platform in enumerate(['gpu', 'gpu2']):
            ax = ax_arr[row][col]
            plt.sca(ax)
