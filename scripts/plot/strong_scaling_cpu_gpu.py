...
gconfig = {
    ...
    'colors': {
        'f64-cpu': 'xkcd:black',
        'HBLonD': 'xkcd:orange',
        'HBLonD-32b': 'xkcd:orange',
        'CuBLonD': 'xkcd:sky blue',
        'CuBLonD-32b': 'xkcd:sky blue',
        'f32-SRP-2': 'xkcd:red',
        'f32-SRP-3': 'xkcd:red',
    ...
    'legend': {
        ...
        'framealpha': 0.7, 'fontsize': 9, 'labelspacing': 0, 'borderpad': 0.3,
