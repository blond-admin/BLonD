...
gconfig = {
    ...
    'outfiles': ['{}/{}-{}.png'],
    'files': [
        '{}/{}/approx0-weak-scaling-cpu/comm-comp-report.csv',
        '{}/{}/approx0-weak-scaling-cpu-gpu/comm-comp-report.csv',
        '{}/{}/approx0-weak-scaling-gpu/comm-comp-report.csv',
    ],
    'lines': {
        'type': ['total', 'total_time'],
    }
