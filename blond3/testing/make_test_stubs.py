...
COVERAGE_JSON_PATH = (
    Path(__file__).parent / Path("../../unittests_blond3/coverage.json")
).resolve()
PROJECT_ROOT = (Path(__file__).parent / Path("../../blond3/")).resolve()
TEST_ROOT = (Path(__file__).parent / Path("../../unittests_blond3")).resolve()
