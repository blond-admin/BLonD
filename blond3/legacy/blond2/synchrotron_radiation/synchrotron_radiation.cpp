...
extern "C" void synchrotron_radiation(real_t * __restrict__ beam_dE, real_t U0,
                                      const int n_macroparticles, real_t tau_z,
                                      const int n_kicks) {
...
extern "C" void synchrotron_radiation_full(real_t * __restrict__ beam_dE, real_t U0,
        const int n_macroparticles, const real_t sigma_dE,
        real_t tau_z, const real_t energy,
        const int n_kicks)
{
    // Adjust inputs before the loop to reduce computations
    U0 = U0 / n_kicks;
